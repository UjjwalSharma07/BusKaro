...
const NewsLetter = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:8800/api/v1/auth/subscribe', email);
  ...
  return (
    <div className="w-full items-center justify-center bg-slate-400 text-black m-10">
      <div className="container mx-auto text-center p-6">
        <h1 className="text-4xl font-bold mb-4 text-gray-800">Save time, save money!</h1>
        <p className="text-lg mb-6 text-gray-700">
          Sign up and we'll send the best deals to your inbox.
        </p>
